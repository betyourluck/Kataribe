...
export const messages = {
  ja: {
    ...
    state: {
      ...
      tabFacts: "約束事",
      tabFactsTitle: "約束事 (GM に守らせたい設定) — Ctrl+5 / Ctrl+Tab で切替",
      factsEmpty:
        "GM に守らせたい設定をここに書きます。呼称・関係・過去・目標・交わした約束など、忘れてほしくないことを 1 行ずつ。書いた内容は毎ターン GM に渡され、以後の語りで守られます（ただし数値や所持品などの状態は正本が優先されます）。",
      factsPlaceholder: "GM に守らせたい設定を 60 字以内で",
      factsAdd: "追加",
      factsGm: "GM",
      factsUser: "あなた",
      factsEvicted: "約束事が満杯のため「{text}」が押し出されました",
      factsRestricted: "このシナリオでは、約束事の追記は作者が制限しています (削除はできます)。",
  ...
  en: {
    ...
    state: {
      ...
      tabFacts: "Facts",
      tabFactsTitle: "Facts (settings the GM must honor) — Ctrl+5 / Ctrl+Tab to switch",
      factsEmpty:
        "Write settings you want the GM to honor — names, relationships, backstory, goals, promises. One line each. They are sent to the GM every turn and kept consistent in later narration (though engine state always wins for numbers and items).",
      factsPlaceholder: "A setting for the GM to honor (up to 60 chars)",
      factsAdd: "Add",
      factsGm: "GM",
      factsUser: "You",
      factsEvicted: 'Memo list was full — "{text}" was pushed out',
      factsRestricted: "The author restricted adding facts in this scenario (you can still delete).",
