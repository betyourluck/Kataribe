...
export const messages = {
  ja: {
    ...
    state: {
      ...
      tabMemo: "メモ",
      tabMemoTitle: "共有メモ (GM とあなたの覚え書き) — Ctrl+5 / Ctrl+Tab で切替",
      memoEmpty: "メモはまだありません。GM が覚えておきたいことを書き溜め、あなたも追加・編集・削除できます。",
      memoPlaceholder: "覚えておきたいことを 60 字以内で",
      memoAdd: "追加",
      memoGm: "GM",
      memoUser: "あなた",
      memoEvicted: "メモが満杯のため「{text}」が押し出されました",
      memoNewLine: "📝 メモ: {text}",
      memoReinforcedLine: "📝⁺ 強化: {text}",
      memoRestricted: "このシナリオでは、メモの追記は作者が制限しています (削除はできます)。",
      memoEditTitle: "編集 (書き換えると押し出されにくくなります)",
      memoDeleteTitle: "削除",
      memoSave: "保存",
      memoCancel: "キャンセル",
      turn: "ターン",
  ...
  en: {
    ...
    state: {
      ...
      tabMemo: "Memo",
      tabMemoTitle: "Shared memo (notes by the GM and you) — Ctrl+5 / Ctrl+Tab to switch",
      memoEmpty: "No memos yet. The GM jots down things worth remembering; you can add, edit and delete too.",
      memoPlaceholder: "Something to remember (up to 60 chars)",
      memoAdd: "Add",
      memoGm: "GM",
      memoUser: "You",
      memoEvicted: 'Memo list was full — "{text}" was pushed out',
      memoNewLine: "📝 Memo: {text}",
      memoReinforcedLine: "📝⁺ Reinforced: {text}",
      memoRestricted: "The author restricted adding memos in this scenario (you can still delete).",
      memoEditTitle: "Edit (editing makes it harder to push out)",
      memoDeleteTitle: "Delete",
      memoSave: "Save",
      memoCancel: "Cancel",
      turn: "Turn",
      goals: "Goals",
