...
export const messages = {
  ja: {
    ...
    state: {
      ...
      tabFacts: "約束事",
      tabFactsTitle: "約束事 (GM とあなたが共有している取り決め) — Ctrl+5 / Ctrl+Tab で切替",
      factsEmpty:
        "約束事はまだありません。GM が忘れてはいけないことを書き留めます。ここに書かれたことは以後の語りで守られます（推測や仮説ではなく、確定したことを書いてください）。",
      factsPlaceholder: "確定したことを 60 字以内で",
      factsAdd: "追加",
      factsGm: "GM",
      factsUser: "あなた",
      factsEvicted: "約束事が満杯のため「{text}」が押し出されました",
      factsNewLine: "📝 約束事に追加: {text}",
      factsReinforcedLine: "📝⁺ 強化: {text}",
  ...
  en: {
    ...
    state: {
      ...
      tabFacts: "Facts",
      tabFactsTitle: "Established facts (shared by the GM and you) — Ctrl+5 / Ctrl+Tab to switch",
      factsEmpty:
        "No established facts yet. The GM records what it must not forget. Anything here is honored in later narration — write what is settled, not guesses.",
      factsPlaceholder: "Something settled (up to 60 chars)",
      factsAdd: "Add",
      factsGm: "GM",
      factsUser: "You",
      factsEvicted: 'Memo list was full — "{text}" was pushed out',
      factsNewLine: "📝 Noted: {text}",
      factsReinforcedLine: "📝⁺ Reinforced: {text}",
