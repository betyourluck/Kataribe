...
export const messages = {
  ja: {
    ...
    state: {
      ...
      tabMapTitle: "マップ (行ける場所の地図) — Ctrl+4 / Ctrl+Tab で切替",
      tabSynopsisTitle: "あらすじ (これまでの章・最近の出来事) — Ctrl+5 / Ctrl+Tab で切替",
      tabMemo: "メモ",
      tabMemoTitle: "共有メモ (GM とあなたの覚え書き) — Ctrl+3 / Ctrl+Tab で切替",
  ...
  en: {
    ...
    state: {
      ...
      tabMapTitle: "Map (where you can go) — Ctrl+4 / Ctrl+Tab to switch",
      tabSynopsisTitle: "Synopsis (chapters so far, recent events) — Ctrl+5 / Ctrl+Tab to switch",
      tabMemo: "Memo",
      tabMemoTitle: "Shared memo (notes by the GM and you) — Ctrl+3 / Ctrl+Tab to switch",
